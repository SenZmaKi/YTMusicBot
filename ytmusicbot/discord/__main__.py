...
async def queue_command(inter: disnake.ApplicationCommandInteraction, title_or_url: str):
    await logic.queue(title_or_url, inter)


@bot.slash_command(description="Clear the song queue")
async def clear_queue(inter: disnake.ApplicationCommandInteraction): await logic.clear_queue(inter)

@bot.slash_command(name="next", description="Play the next song")
async def next_command(inter: disnake.ApplicationCommandInteraction): await logic.next_(inter)

@bot.slash_command(description="Play the previous song")
async def previous(inter: disnake.ApplicationCommandInteraction): await logic.previous(inter)

@bot.slash_command(description="Pause playback")
async def pause(inter: disnake.ApplicationCommandInteraction): await logic.pause(inter)

@bot.slash_command(description="Resume playback")
async def resume(inter: disnake.ApplicationCommandInteraction): await logic.resume(inter)

@bot.slash_command(description="Stop playback")
async def stop(inter: disnake.ApplicationCommandInteraction): await logic.stop(inter)

@bot.slash_command(description="Show the song queue")
async def show_queue(inter: disnake.ApplicationCommandInteraction): await logic.show_queue(inter)

@bot.slash_command(description="Remove a song from the queue")
async def dequeue(inter: disnake.ApplicationCommandInteraction, song_number: int): await logic.dequeue(inter, song_number)

@bot.slash_command(description="Remove the next song")
async def dequeue_next(inter: disnake.ApplicationCommandInteraction): await logic.dequeue_next(inter)

@bot.slash_command(description="Remove the previous song")
async def dequeue_previous(inter: disnake.ApplicationCommandInteraction): await logic.dequeue_previous(inter)

@bot.slash_command(description="Remove the current song")
async def dequeue_current(inter: disnake.ApplicationCommandInteraction): await logic.dequeue_current(inter)

@bot.slash_command(description="Skip to a numbered song")
async def skip_to(inter: disnake.ApplicationCommandInteraction, song_number: int): await logic.skip_to(inter, song_number)

@bot.slash_command(description="Set playback volume")
async def set_volume(inter: disnake.ApplicationCommandInteraction, volume: int): await logic.set_volume(inter, volume)

@bot.slash_command(description="Increase volume by 10 percent")
async def increase_volume(inter: disnake.ApplicationCommandInteraction): await logic.increase_volume(inter)

@bot.slash_command(description="Decrease volume by 10 percent")
async def decrease_volume(inter: disnake.ApplicationCommandInteraction): await logic.decrease_volume(inter)

@bot.slash_command(description="Mute playback")
async def mute(inter: disnake.ApplicationCommandInteraction): await logic.mute(inter)

@bot.slash_command(description="Unmute playback")
async def unmute(inter: disnake.ApplicationCommandInteraction): await logic.unmute(inter)

@bot.slash_command(description="Show the current song")
async def now_playing(inter: disnake.ApplicationCommandInteraction): await logic.now_playing(inter)

@bot.slash_command(name="loop", description="Enable looping")
async def loop_command(inter: disnake.ApplicationCommandInteraction): await logic.loop(inter)
...
async def show_favourites(inter: disnake.ApplicationCommandInteraction): await logic.show_favourites(inter)

@bot.slash_command(description="Play favourite songs")
async def play_favourites(inter: disnake.ApplicationCommandInteraction): await logic.play_favourites(inter)

@bot.slash_command(name="random", description="Play random songs")
async def random_command(inter: disnake.ApplicationCommandInteraction): await logic.random_(inter)

@bot.slash_command(description="Link to the bot source")
async def repo(inter: disnake.ApplicationCommandInteraction): await logic.repo(inter)

@bot.slash_command(description="Link to the bot creator")
async def creator(inter: disnake.ApplicationCommandInteraction): await logic.creator(inter)
...
async def on_button_click(inter: disnake.MessageInteraction):
    try:
        ...
        exact_handlers = {
            ButtonID.next: logic.next_, ButtonID.previous: logic.previous,
            ButtonID.pause: logic.pause, ButtonID.resume: logic.resume,
        ...
        for pattern, handler in (
            (ButtonID.play_rx, logic.play), (ButtonID.queue_rx, logic.queue),
